...
import 'package:victim_app/Models/placePredictions.dart';
import 'package:victim_app/configMaps.dart';
...
class _SearchScreenState extends State<SearchScreen>
{
      ...
      body: Column(
        children: [
          Container(
            ...
            child: Padding(
              padding: EdgeInsets.only(left: 25.0, top: 25.0, right: 20.0, bottom: 20.0),
              child: Column(
                children: [
                  SizedBox(height: 5.0),
                  Stack(
                    children: [
                      ...
                      Center(
                        child: Text("Set Destination", style: TextStyle(fontSize: 18.0, fontFamily: "Poppins-Bold"),),
                      ),
                    ],
                  ),
  ...
  void findPlace(String placeName) async
  {
    if(placeName.length > 1)
      {
        String autoCompleterUrl = "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$placeName&key=$mapKey&sessiontoken=1234567890&components=country:ke";

        var res = await RequestAssistant.getRequest(autoCompleterUrl);
